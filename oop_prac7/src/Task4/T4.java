...
public class T4 extends JFrame {
    public T4(){
        ...
        JButton addFirst = new JButton("Первому"), addSecond = new JButton("Второму"), playButton = new JButton("Старт");
        p.add(addFirst);
        p.add(addSecond);

        JPanel p1 = new JPanel();
        p1.add(new JLabel("Игрок1:"));
        p1.add(firstStart);

        JPanel p2 = new JPanel();
        p2.add(new JLabel("Игрок2:"));
        p2.add(secondStart);
        ...
        playButton.addActionListener(e->{
            JOptionPane.showMessageDialog(this, new T1(firstStart.getText(), secondStart.getText()).play());
            firstStart.setText("");
            secondStart.setText("");
            curAdd.setText("0");
